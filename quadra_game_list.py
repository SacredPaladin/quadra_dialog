...
game_number = {
	...
	'kingsway' : ['보는 맛은 없을지 몰라도 하는 거는 재밌는 게임이지.','588950']
	'captain forever remix' : ['부수고! 빼앗고! 조립하고!','298560']
	'clannad' : ['이 게임의 진입장벽으로는 눈 크기가 있지.','324160']
	"mirror's edge" : ['도시를 박차고 날아댕기는.. 거는 아니지만, 주인공은 거의 그 수준이지.','17410']
	'nidhogg' : ['실제 검술과는 많이 다르지만.. 뭐 어때! 재밌으면 그만이지.','94400']
}
...
game_synonym = {
	...
	'kingsway' : ['킹스웨이']
	'captain forever remix' : ['캡틴 포에버 리믹스','캡틴포에버 리믹스','캡틴포에버리믹스']
	'clannad' : ['클라나드']
