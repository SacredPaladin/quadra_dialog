...
game_number = {
	...
	'ftl: faster than light' : ['제발 버레II 나와라..','212680']
	'the binding of issac: rebirth' : ['홀리 멘틀 개사기','250900']
	'downwell' : ['에라이 카레존망겜','360740']
	'enter the gungeon' : ['예에에에에~ 엔터 더 건-전'. '311690']
	'titan souls' : ['아- 아- 아- (따라부르기)','297130']
	'you must build a boat' : ['유! 머스트! 빌드! 어! 보트!','290890']
	'doki doki literature club' : ['그래.. 참 두근두근한 게임이지.. (시선회피), '698780']
        'paper, please' : ['동무 려권내라우!', '239030']
	'reigns' : ['왕위를 계승중입니다, 아버지. - 워크래프트'.'474750']
	'this war of mine' : ['그거 분위기는 우울한데 실상은 살인 난장판인 게임인 거로 아는데..'.'282070']
}
game_synonym = {
	"playerunknown's battlegrounds" : ['배그','배틀그라운드'],
	'darkest dungeon' : ['다키스트 던전','다키스트던전','닼던']
	'ftl: faster than light' : ['ftl', 'FTL']
